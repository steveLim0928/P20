...
void receiver::init(bool *Data, bool *Char, bool *sendPin, bool *receivePin, bool *senderReady, bool *receiverAck, bool *senderAck, QMutex *mtx) { // Initialise all data to have address
...
void receiver::receiveData() {
    ...
    *rAck = 1;
    ...
    qDebug() << "Receiver: Receive sender Ack";
    ...
    QDataStream deserial(rChar);
    QChar c;
    deserial >> c;

    qDebug() << "Receiver: Char received: " << c;
