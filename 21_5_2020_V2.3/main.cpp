...
int main(int argc, char *argv[])
{
    ...
    QObject::connect(receive, &receiver::sendText, &receiveWin, &drawing::onTextPressed);
    QObject::connect(receive, &receiver::sendSetText, &receiveWin, &drawing::onSetText);
    QObject::connect(receive, &receiver::sendSetTextSize, &receiveWin, &drawing::onSetTextSize);
